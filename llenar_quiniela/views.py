...
def ingresar_resultado(request):
    ...
    if car == 'DQ':
        ...
        consejo = 'JUGADOR GOL (J): Rellena tu quiniela de forma normal. Selecciona el equipo donde está tu jugador para echar gol (si el equipo no está disponible, entonces busca otro jugador de otro equipo disponible). Por último, con una sola palabra, escribe el jugador seleccionado.'
    elif car == 'M':
